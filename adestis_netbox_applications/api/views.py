...
from .serializers import InstalledApplicationSerializer, SoftwareSerializer, InstalledApplicationTypesSerializer, SoftwareVersionSerializer
...
class SoftwareVersionViewSet(NetBoxModelViewSet):
    queryset = SoftwareVersion.objects.prefetch_related(
        'tags'
    )
